<template>
  ...
  <v-row class="mb-6 header-row">
    <v-col>
      <h1 class="text-h4 font-weight-600 header-title">Equipment Readiness Report</h1>
      <p class="text-gray-600 header-subtitle">Overview of equipment status and operational ratings</p>
    </v-col>
  </v-row>
 ...
 <!-- Stats Section (2x2 grid) -->
  ...
  <v-row class="mb-6">
    ...
    <v-col cols="12" lg="6">
      <ratings-line-graph :data="ratingsData" :title="'Equipment Readiness Rating Line Graph'"/>
    </v-col>

    <!-- Ratings Line Graph (Bottom Right) -->
    <v-col cols="12" lg="6">
      <ratings-line-graph :data="ratingsDataMaintenance" :title="'Maintenance Readiness Rating Line Graph'"/>
    </v-col>
  </v-row>
</template>
